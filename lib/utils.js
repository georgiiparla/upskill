...
export const generateThemeGradientPalette = (colorBase, theme, isMantra) => {
    // The tinycolor library is essential here for reliable HSL conversion.
    ...
    if (isMantra) {
        // Mantra treatment: Shift towards red/pink tones (Hue 0-20), keep brighter.
        h = base.toHsl().h > 200 ? 350 : 10; // Shift toward red/pink hue (0-20 or 350-360)
        s = Math.min(s, 0.9); // Cap saturation
    }

    if (theme === 'dark') {
        // Dark Theme: Deep, low-saturation.
