...
const MetricItem = ({ icon, label, allTime, thisWeek }) => (
    <div className="group bg-white dark:bg-slate-800 p-5 rounded-xl border border-slate-200 dark:border-slate-700 hover:shadow-md transition-all duration-200 hover:scale-[1.02]">
        <div className="flex items-start space-x-4">
            <div className="flex-shrink-0 mt-1 p-1.5 bg-white dark:bg-slate-900 rounded-lg shadow-sm group-hover:shadow-md transition-shadow duration-200">{icon}</div>
