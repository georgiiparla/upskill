...
export const UsersList = ({ initialUsers = [] }) => {
    ...
    return (
        <Card>
            ...
            >
                {/* 1. Add className="!mb-0" to remove the bottom margin from the title. */}
                {/* The "!" is important to override the component's default style. */}
            ...
            {isOpen && (
                // 2. Add "mt-4" to the content wrapper to restore the spacing.
